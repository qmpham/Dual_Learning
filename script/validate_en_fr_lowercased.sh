...
# model prefix
prefix=/users/limsi_nmt/minhquang/nematus-master/models/model_lowercased_with_prior/model_en_fr/model_en_fr.npz

dev=/users/limsi_nmt/minhquang/Dual_NMT/data/validation/hit/hit.en.tok.shuf.dev.tok
ref=/users/limsi_nmt/minhquang/Dual_NMT/data/validation/hit/hit.fr.tok.shuf.dev.tok
