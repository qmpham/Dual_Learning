...
export PYTHONPATH=$MYPYLIB:$faiss:$nematus:$MYPYLIB/python2.7:$MYPYLIB/python2.7/dists-packages
...
which python
python -c 'import faiss; print "faiss OK"; import numpy; print "numpy OK"; import theano; print "theano OK"; import nematus; print "nematus OK"'
